...
{
    public class DragAndDropAppServices : AppServiceBase
    {
        public DragAndDropAppServices(Interfaces.IUnitOfWork theUnitOfWork, IMapper mapper) : base(theUnitOfWork, mapper)
        {
