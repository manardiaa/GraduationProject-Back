...
namespace BL.AppServices
{
    public class PaymentAppService : AppServiceBase
    {
        ...
        public List<PaymentViewModel> GetPaymentsOfUser(string id)
        {
            ...
            return GetAllPayments().Where(p => p.ApplicationStudentIdentity_Id == id).ToList();
        }
        ...
        public bool SaveNewPayment(PaymentViewModel paymentViewModel)
        {
            if (paymentViewModel == null)
                throw new ArgumentNullException();
            if (paymentViewModel.ApplicationStudentIdentity_Id == null || paymentViewModel.ApplicationStudentIdentity_Id == string.Empty)
